...
define_antenna_layer_rule $lib -mode 4 -layer "ME5" -ratio 400 -diode_ratio {0.1024 0 200 2000}
define_antenna_layer_rule $lib -mode 4 -layer "ME6" -ratio 400 -diode_ratio {0.1024 0 200 2000}
define_antenna_layer_rule $lib -mode 4 -layer "ME7" -ratio 400 -diode_ratio {0.1024 0 200 1500}
define_antenna_layer_rule $lib -mode 4 -layer "ME8" -ratio 400 -diode_ratio {0.1024 0 200 1500}
...
define_antenna_layer_rule $lib -mode 5 -layer "ME6" -ratio 400 -diode_ratio {0.1024 0 200 2000}
define_antenna_layer_rule $lib -mode 5 -layer "ME7" -ratio 400 -diode_ratio {0.1024 0 200 2000}
define_antenna_layer_rule $lib -mode 5 -layer "ME8" -ratio 400 -diode_ratio {0.1024 0 200 2000}
